...
她在顶尖的科学期刊上发表了70余篇论文，涉及统计、机器学习、信息论、信号处理、遥感、神经科学和网络研究等领域。她在许多期刊都担任过编委，比如统计年刊（Annals of Statistics）、美国统计协会期刊（Journal of American Statistical Association）、机器学习研究期刊（Journal of Machine Learning）和Technometrics。
